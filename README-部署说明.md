...
```bash
# 方式一：命令行导入
mysql -u root -p sparchetype < scripts/sql/backup_sparchetype_20260623_220530.sql

# 方式二：使用 Navicat / DataGrip 等工具打开 SQL 文件并执行

# 方式三：使用 MySQL 命令行客户端
source d:/Desktop/MES-Springboot/scripts/sql/backup_sparchetype_20260623_220530.sql;
```

> 脚本路径：`scripts/sql/backup_sparchetype_20260623_220530.sql`
>
...
│   └── pom.xml                 # Maven 构建配置
├── scripts/sql/                # 数据库脚本
│   └── backup_sparchetype_20260623_220530.sql  # 完整数据库初始化脚本
├── README.md                   # 项目介绍
└── README-部署说明.md          # 本文件
```
